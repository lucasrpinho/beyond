...
Partial Public Class PedidosDS
    ...
    Partial Public Class DTItensVendidosDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddDTItensVendidosRow(ByVal nome_produto As String, ByVal quantidade As Integer, ByVal parentDTPedidoRowByDTPedido_DTItensVendidos As DTPedidoRow, ByVal de_categoria As String) As DTItensVendidosRow
            Dim rowDTItensVendidosRow As DTItensVendidosRow = CType(Me.NewRow,DTItensVendidosRow)
            Dim columnValuesArray() As Object = New Object() {nome_produto, quantidade, Nothing, de_categoria}
